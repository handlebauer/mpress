...
interface LongPressOptionsProps {
  min: number
  max: number
  length: number
  enabled: boolean
  ...
  onEnableChange: (state: CheckedState) => void
  onDoneClick: () => void
}

export default function LongPressOptions(props: LongPressOptionsProps) {
  return (
    <div className="space-y-7 p-2">
      <div className="flex flex-col space-y-3">
        <div className="flex items-center space-x-2">
          ...
          {props.length !== LONG_PRESS_DEFAULT_LENGTH && (
